...
import com.example.dividens_stock.model.constants.Month;
...
public class YahooFinanceScraper implements Scraper {
    ...
    public ScrapedResult scrap(Company company) {
        ...
        // 처리할 웹사이트의 html코드를 잘 확인하고 파악해야 할 것.
        try {

            long now = System.currentTimeMillis() / 1000;   // millisecond -> second
