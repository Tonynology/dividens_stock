...
import com.example.dividens_stock.service.CompanyService;
...
public class CompanyController {
    ...
    public ResponseEntity<?> autocompany(@RequestParam String keyword) {
